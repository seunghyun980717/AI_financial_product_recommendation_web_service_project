<template>
  <div class="global-market-dashboard">
    <div class="dashboard-grid">
      <!-- S&P 500 차트 -->
      <div class="chart-card">
        <h3 class="chart-title">S&P 500 (최근 30일)</h3>
        <div class="chart-placeholder">
          <canvas ref="sp500Chart"></canvas>
        </div>
      </div>

      <!-- NASDAQ 차트 -->
      <div class="chart-card">
        <h3 class="chart-title">NASDAQ (최근 30일)</h3>
        <div class="chart-placeholder">
          <canvas ref="nasdaqChart"></canvas>
        </div>
      </div>
...
const sp500Chart = ref(null)
const nasdaqChart = ref(null)
...
onMounted(() => {
  fetchExchangeRates()
  createChartWithData(sp500Chart, '^GSPC', 'S&P 500', '#2563eb')
  createChartWithData(nasdaqChart, '^IXIC', 'NASDAQ', '#10b981')
})
</script>
